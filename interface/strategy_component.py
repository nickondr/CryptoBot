    ...
    def __init__(self, root, binance: BinanceFuturesClient, bitmex: BitmexClient, *args, **kwargs):
        ...
        self._base_params = [
            ...
            {"code_name": "parameters", "widget": tk.Button, "data_type": float,
             "text": "Params", "bg": BG_COLOR_2, "command": self._show_popup, "header": "", "width": 10},
        ...
        self._extra_params = {
            "Technical": [{"code_name": "rsi_length", "name": "RSI Periods", "widget": tk.Entry, "data_type": int},
                          ...
                          {"code_name": "ema_signal", "name": "MACD Signal Length", "widget": tk.Entry,
                           "data_type": int}],
